...
export default function EventExpense(props) {

    const {id, event, reason} = props.route.params
  ...
  return (
    <ScreenWrapper className="flex-1">
        ...
        <View className="relative mt-5">
                ...
                <View>
                     <Text className={`${colors.heading} text-xl font-bold text-center`}>{event}</Text>
                     <Text className={`${colors.heading} text-xm  text-center`}>{reason} </Text>
                </View>
